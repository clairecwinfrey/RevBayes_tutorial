...
see how to use rotl help page in R
```{r, eval=TRUE}
...
GetTreeFromOpenTree <- function() {
 ...
 formica.id <- tnrs_match_names("__________")$ott_id
...
```{r, eval=FALSE}
  ...
  formica.study1.tree1 <- get_______FUNCTION_FROM_rotl____(formica.studies.ids[[1]])
